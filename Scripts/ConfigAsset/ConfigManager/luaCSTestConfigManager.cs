...
namespace DataClass
{
    public class luaCSTestConfigManager :BaseConfig<luaCSTestConfigManager,luaCSTestConfig>
    {
        public override void Init( )
        {
            ...
            config1.intArrayData3 = new int[][]{new int[]{new int[]{1,2},new int[]{2,5,9},new int[]{1,7,8,9},new int[]{9}}};
            config1.test1 = new Dictionary<int,int>{  {15,89}, {51,48}, {17,20}};
            config1.test2 = new Dictionary<int,int[]>{new int[]{1,{1,8,9}},new int[]{1005,{5,8,9,45}},new int[]{28,{15,9,15}}};
            ...
            config2.intArrayData3 = new int[][]{new int[]{new int[]{1,2},new int[]{2,5,9},new int[]{1,7,8,9},new int[]{9}}};
            config2.test1 = new Dictionary<int,int>{  {15,89}, {51,48}, {17,20}};
            config2.test2 = new Dictionary<int,int[]>{new int[]{1,{1,8,9}},new int[]{1005,{5,8,9,45}},new int[]{28,{15,9,15}}};
